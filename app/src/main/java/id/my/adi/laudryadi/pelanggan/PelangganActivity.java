...
import id.my.adi.laudryadi.adapater.AdapterPelanggan;
...
public class PelangganActivity extends AppCompatActivity {
    ...
    ArrayList<ModelPelangganActivity.ModelPelanggan> list; // List untuk menyimpan data pelanggan
    ...
    private View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            ModelPelangganActivity.ModelPelanggan mp = list.get(position); // Ambil data pelanggan dari posisi yang diklik
    ...
    private void getData() {
        ...
        try {
            List<ModelPelangganActivity.ModelPelanggan> p = db.getPelanggan(); // Ambil data dari database
            if (p.size() > 0) {
                for (ModelPelangganActivity.ModelPelanggan pel : p) {
    ...
    private void setView() {
        ...
        btnPelAdd = findViewById(R.id.btnPelAddBatal); // Temukan tombol tambah pelanggan dari layout
        rvPelanggan = findViewById(R.id.cvPelanggan); // Temukan RecyclerView dari layout
