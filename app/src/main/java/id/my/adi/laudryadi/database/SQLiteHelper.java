...
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    public boolean insertPelanggan(ModelPelangganActivity.ModelPelanggan mp) {
    ...
    public List<ModelPelangganActivity.ModelPelanggan> getPelanggan() {
        List<ModelPelangganActivity.ModelPelanggan> pel = new ArrayList<>();
        ...
        if (cursor.moveToFirst()) {
            do {
                ModelPelangganActivity.ModelPelanggan k = new ModelPelangganActivity.ModelPelanggan();
